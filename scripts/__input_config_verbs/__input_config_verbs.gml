...
return {
    ...
    gamepad:
    {
        ...
        alt_shoot:     [input_binding_gamepad_button(gp_shoulderl), input_binding_gamepad_button(gp_shoulderr)],
		
		scroll_up: input_binding_gamepad_button(gp_padu),
		scroll_down: input_binding_gamepad_button(gp_padd),
